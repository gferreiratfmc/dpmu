...
*-------------------------------------------------------------------
* SVN  $Id: cobl_crc.c 31977 2020-05-07 09:35:53Z ro $
*
*
*-------------------------------------------------------------------
*
...
/**
* \file
* \brief cobl_crc.c - CRC calculation
*
...
#ifdef CRC_USER
#else /* CRC_USER */
/** CRC use value table in Flash for calculation */
...
#ifdef CRC_USER
	retVal = crcUser(pBuffer, u16StartValue, u32Count);
#endif
...
/********************************************************************/
/**
* \brief crc calculation with table
* Polynom: CCITT_MASK
*
* \returns 
*	CRC sum
...
/********************************************************************/
/**
 * \brief check the CRC definition in CiA 301
...
/********************************************************************/
/**
 * \brief print the RAM CRC table to define it in ROM
 * \internal
 */
static void printTable(void)
{
