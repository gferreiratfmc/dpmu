...
#define SOFTSTART_MAX_SAFE_RETRIES 30
#define SOFTSTART_SAFE_LIMIT_DUTY_CYCLE_RATIO 0.25
#define SOFTSTART_MAX_SAFE_VOLTAGE_TO_INRUSH  80.0
#define SOFTSTART_DEVIATION_FROM_STORAGE_VOLTAGE_TO_INRUSH 2.0
