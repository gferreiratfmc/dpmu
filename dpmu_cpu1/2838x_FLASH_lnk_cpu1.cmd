...
MEMORY
{
   ...
   CONFIG			: origin = 0x084000, length = 0x100
   BEGIN            : origin = 0x084100, length = 0x000002
...
//   RAMGS15_RSVD     : origin = 0x01CFF8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   /* Flash sectors */
   FLASH2           : origin = 0x084102, length = 0x002000 - 0x100 - 0x2  /* on-chip Flash */
...
//   FILE_SYSTEM      : origin = 0x300000, length = 0x004000
...
SECTIONS
{
   sharedVars_cpu1toCpu2: > RAMGS2

   sharedVars_cpu2toCpu1: > RAMGS3

   codestart           : > BEGIN, ALIGN(8)
   .text               : >> FLASH2 | FLASH3 | FLASH4 | FLASH5 | FLASH6, ALIGN(8)
   .cinit              : > FLASH4 | FLASH5 | FLASH6, ALIGN(8)
   .switch             : > FLASH3, ALIGN(8)
   .reset              : > RESET, TYPE = DSECT /* not used, */
   .stack              : > RAMLS5 | RAMLS6 | RAMLS7 //RAMM1
