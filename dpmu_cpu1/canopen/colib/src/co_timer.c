...
*-------------------------------------------------------------------
* $Id: co_timer.c 41218 2022-07-12 10:35:19Z boe $
*
*
*-------------------------------------------------------------------
*
...
---------------------------------------------------------------------------*/
static UNSIGNED32	timerInterVal;
static CO_TIMER_T	*pCoTimer;
static UNSIGNED32	actTick;
...
*
* This function starts a timer with the given timer interval (in usec).
...
RET_T coTimerStart(
		...
		UNSIGNED32	timerTime,			/**< timer time in usec */
...
*/
void coTimerInit(
		UNSIGNED32	timerVal		/**< timer interval in usec */
	)
{
