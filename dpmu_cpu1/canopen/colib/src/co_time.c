...
*-------------------------------------------------------------------
* $Id: co_time.c 29114 2019-08-30 15:38:11Z phi $
*
*
*-------------------------------------------------------------------
*
...
RET_T			retVal;
	...
	coNumMemcpyUnpack(&trData[0], &pTimeData->msec, 4u, 1u, 0u);
	coNumMemcpyUnpack(&trData[4], &pTimeData->days, 2u, 1u, 0u);

	/* transmit data */
	retVal = icoTransmitMessage(timeProdCob, &trData[0], MSG_OVERWRITE);
