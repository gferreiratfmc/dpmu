...
*
* Copyright (c) 2016-2020 emotas embedded communication GmbH
*-------------------------------------------------------------------
* $Id: co_nmtslave.c 30776 2020-02-20 07:51:40Z boe $
*
*
*-------------------------------------------------------------------
*
...
RET_T ret = RET_OK;
	...
	if (ret == RET_OK)  {
		if ((selfStartUp & CO_NMT_STARTUP_BIT_STARTNODE) == CO_NMT_STARTUP_BIT_STARTNODE)  {
