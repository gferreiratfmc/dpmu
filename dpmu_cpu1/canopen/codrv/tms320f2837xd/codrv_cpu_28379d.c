...
*-------------------------------------------------------------------
* $Id: codrv_cpu_28379d.c 33050 2020-08-10 16:06:02Z ro $
*
*
*-------------------------------------------------------------------
*
...
#define CPUCLK_FREQUENCY 200u /* 200 MHz Systemfrequency*/
	...
	)
{
	...
	ConfigCpuTimer(&CpuTimer0, CPUCLK_FREQUENCY, timerInterval);
