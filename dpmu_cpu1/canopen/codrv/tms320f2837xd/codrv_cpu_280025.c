...
void codrvHardwareCanInit(void)
{
    ...
    EALLOW;
    Interrupt_register(INT_CANA0, codrvCan0Irq);
    EDIS;
}
...
uint32_t temp;
	...
	Interrupt_register(INT_TIMER0, codrvTimerISR);
...
//	StartCpuTimer0();
    ...
    temp = (uint32_t)((DEVICE_SYSCLK_FREQ / 1000000U) * timerInterval);
