...
static RET_T indices_I_DC_BUS_VOLTAGE(UNSIGNED8 subIndex)
{
    ...
    case S_MIN_ALLOWED_DC_BUS_VOLTAGE:
        ...
        Serial_debug(DEBUG_INFO, &cli_serial, "S_MIN_ALLOWED_DC_BUS_VOLTAGE: 0x%x, value_converted:[%6.2f]\r\n", value, value_converted);
        break;
    case S_MAX_ALLOWED_DC_BUS_VOLTAGE:
        ...
        Serial_debug(DEBUG_INFO, &cli_serial, "S_MAX_ALLOWED_DC_BUS_VOLTAGE: 0x%x, value_converted:[%6.2f]\r\n", value, value_converted);
        break;
    case S_TARGET_VOLTAGE_AT_DC_BUS:
        ...
        Serial_debug(DEBUG_INFO, &cli_serial, "S_TARGET_VOLTAGE_AT_DC_BUS: 0x%x, value_converted:[%6.2f]\r\n", value, value_converted);
        break;
    case S_VDC_BUS_SHORT_CIRCUIT_LIMIT:
        ...
        Serial_debug(DEBUG_INFO, &cli_serial, "S_VDC_BUS_SHORT_CIRCUIT_LIMIT: 0x%x, value_converted:[%6.2f]\r\n", value, value_converted);
        break;
    case S_VDROOP:
        ...
        Serial_debug(DEBUG_INFO, &cli_serial, "S_VDROOP: 0x%x, value_converted:[%6.2f]\r\n", value, value_converted);
        break;
    default:
        Serial_debug(DEBUG_ERROR, &cli_serial, "UNKNOWN CAN OD SUBINDEX: 0x%x\r\n", subIndex);
    }
...
static RET_T indices_I_ESS_CURRENT(void)
{
    ...
    Serial_debug(DEBUG_INFO, &cli_serial, "I_ESS_CURRENT: 0x%x value_converted:[%6.2f]\r\n", value, value_converted);
...
static RET_T indices_I_ENERGY_CELL_SUMMARY(UNSIGNED8 subIndex)
{
    ...
    case S_MIN_VOLTAGE_ENERGY_CELL:
        ...
        if( value_converted <= MAX_VOLTAGE_ENERGY_CELL ) {
            ...
            Serial_debug(DEBUG_INFO, &cli_serial, "S_MIN_VOLTAGE_ENERGY_CELL: 0x%x value_converted:[%6.2f]\r\n", value, value_converted);
        } else {
            Serial_debug(DEBUG_INFO, &cli_serial, "INVALID S_MIN_VOLTAGE_ENERGY_CELL: %x > MAX_VOLTAGE_ENERGY_CELL[%6.2f]\r\n", value, MAX_VOLTAGE_ENERGY_CELL);
    ...
    case S_MAX_VOLTAGE_ENERGY_CELL:
        ...
        if( value_converted <= MAX_VOLTAGE_ENERGY_CELL ) {
            ...
            Serial_debug(DEBUG_INFO, &cli_serial, "S_MAX_VOLTAGE_ENERGY_CELL: 0x%x value_converted:[%6.2f]\r\n ", value, value_converted);
        } else {
            Serial_debug(DEBUG_INFO, &cli_serial, "INVALID S_MAX_VOLTAGE_ENERGY_CELL: %x > MAX_VOLTAGE_ENERGY_CELL:[%6.2f]\r\n", value, MAX_VOLTAGE_ENERGY_CELL);
            retVal = RET_SDO_INVALID_VALUE;
        }
