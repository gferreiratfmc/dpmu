...
//        Serial_debug(DEBUG_INFO, &cli_serial, "S_READ_LOAD_CURRENT: %d\r\n", intValue8);
        break;
...
static inline uint8_t indices_I_SWITCH_STATE(UNSIGNED8 subIndex)
{
    ...
    case S_SW_QINRUSH_STATE:
        ...
        retVal = coOdPutObj_u8(I_SWITCH_STATE, S_SW_QINRUSH_STATE, state);
        break;
    case S_SW_QLB_STATE:
...
//    Serial_debug(DEBUG_INFO, &cli_serial, "SWITCH  S 0x%0x ", subIndex);
